...
BLOG_AUTHOR = "TY Engineers"  # (translatable)
BLOG_TITLE = "TY Engineering"  # (translatable)
...
BLOG_DESCRIPTION = "Blogs and Essays about Software and Data Engineering at TrustYou."  # (translatable)
