...
BLOG_AUTHOR = "TY"  # (translatable)
BLOG_TITLE = "TrustYou Engineering"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://trustyou.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://trustyou.github.io/"
BLOG_EMAIL = "development@trustyou.net"
BLOG_DESCRIPTION = "BLogs and Essays about the Software and Data Engineering at TrustYou"  # (translatable)
